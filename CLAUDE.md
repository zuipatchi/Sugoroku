...
| ミニゲーム起動トリガー（テスト用ボタン・しきい値判定で盤面にボーナス。CPU 対戦＝一人用モードではターン進行と干渉しないよう非表示） | [Assets/Scripts/Main/MiniGameTriggerPresenter.cs](Assets/Scripts/Main/MiniGameTriggerPresenter.cs) |
